...
$(eval $(call platform_build,raspberry_pi_pico_2_w_slot1,thumbv8m.main-none-eabi))
$(eval $(call platform_build,raspberry_pi_pico_2_w_slot2,thumbv8m.main-none-eabi))
$(eval $(call platform_build,raspberry_pi_pico_2_w_probe,thumbv8m.main-none-eabi))
$(eval $(call platform_build,raspberry_pi_pico_2_w_hog,thumbv8m.main-none-eabi))
